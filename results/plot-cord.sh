...
do
  ...
  do
    ...
    echo '        "p'${prb}'-'${src}'.p" using 1:8 every ::1::8 title "O(h^3)" with lines ls 3, \' >> plot.p
    echo '        "p'${prb}'-'${src}'.p" using 1:9 every ::1::6 title "O(h^4)" with lines ls 4' >> plot.p
...
do
  ...
  echo 'set style line 3 lt 1 lc rgb "blue" lw 1' >> plot.p
  echo 'set style line 4 lt 1 lc rgb "magenta" lw 1' >> plot.p
  echo 'plot    "p1-'${src}'.p" using 1:2 title "DD" with points pt 1, \' >> plot.p
  echo '        "p1-'${src}'.p" using 1:3 title "SC" with points pt 2, \' >> plot.p
  echo '        "p1-'${src}'.p" using 1:4 title "LD" with points pt 3, \' >> plot.p
  echo '        "p1-'${src}'.p" using 1:5 title "LC" with points pt 4, \' >> plot.p
  echo '        "p1-'${src}'.p" using 1:6 title "O(h^2)" with lines ls 1, \' >> plot.p
  echo '        "p1-'${src}'.p" using 1:7 title "O(h^2)" with lines ls 2, \' >> plot.p
  echo '        "p1-'${src}'.p" using 1:8 every ::1::8 title "O(h^3)" with lines ls 3, \' >> plot.p
  echo '        "p1-'${src}'.p" using 1:9 every ::1::6 title "O(h^4)" with lines ls 4' >> plot.p
  echo 'set terminal pdfcairo enhanced color dashed' >> plot.p
